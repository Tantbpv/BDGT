...
- move API Gateway to the NestJS microservice (Rejected: Nest.js is a BFF server)
- move Tracking, User management, Labels, etc to the separate microservices with NestJS, API Gateway should be a simple proxy
...
- Inject User Memory to the conversation as a system prompt
- 